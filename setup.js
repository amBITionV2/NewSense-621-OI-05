...
console.log('3. Initialize YouTube videos: npm run init-youtube-videos');
...
console.log('\n🎥 YouTube Videos:');
console.log('- Educational videos are now sourced from curated YouTube content');
console.log('- Run "npm run init-youtube-videos" to load civic sense videos');
